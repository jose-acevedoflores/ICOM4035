...
public interface ScoreList2 {
	 ...
	 * @return null if the array of scores is not full.
	 * If a score is added to a full array then the one removed is returned.
	 * If no score is added then the lowest score is returned.
	 **/ 
